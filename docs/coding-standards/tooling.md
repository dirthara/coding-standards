...
title: Tooling
sidebar_position: 8
description: The development environment, the Composer scripts, and what CI runs against a pull request.
---
...
come from [`dirthara/package-template`](https://github.com/dirthara/package-template). A package does not invent its
own.
