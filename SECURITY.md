...
vulnerability** form on that repository — for example
[`dirthara/database`](https://github.com/dirthara/database/security/advisories/new). Do not disclose vulnerabilities in
public issues or pull requests.

If the problem is here — a standard that tells a maintainer to do something unsafe, such as a page recommending an
insecure default or a weakened check — report it privately through this repository's [Report a
vulnerability](https://github.com/dirthara/coding-standards/security/advisories/new) form. A wrong rule reaches every
package, so it is treated as a vulnerability rather than a documentation bug.
